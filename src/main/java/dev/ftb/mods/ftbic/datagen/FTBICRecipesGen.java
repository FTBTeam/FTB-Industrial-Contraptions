...
public abstract class FTBICRecipesGen extends RecipeProvider implements IConditionBuilder {
	...
	public static final Item LATEX = Items.PAPER;//MyrtreesItems.LATEX.get(); // FIXME: add back (1.19 mod needed from jake)
	public static final Item TREE_TAP = Items.PAPER;//MyrtreesItems.TREE_TAP.get(); // FIXME: add back (1.19 mod needed from jake)
	public static final Item RUBBERWOOD_LOG = Items.PAPER;//MyrtreesItems.RUBBERWOOD_LOG.get(); // FIXME: add back (1.19 mod needed from jake)
	public static final Item RUBBERWOOD_SAPLING = Items.PAPER;//MyrtreesItems.RUBBERWOOD_SAPLING.get(); // FIXME: add back (1.19 mod needed from jake)
	public static final Item RUBBERWOOD_LEAVES = Items.PAPER;//MyrtreesItems.RUBBERWOOD_LEAVES.get(); // FIXME: add back (1.19 mod needed from jake)
