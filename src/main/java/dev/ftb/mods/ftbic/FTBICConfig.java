...
public class FTBICConfig {
	...
	public static int LV_TRANSFER_RATE = 20;
	public static int MV_TRANSFER_RATE = 200;
	public static int HV_TRANSFER_RATE = 2_000;
	public static int EV_TRANSFER_RATE = 10_000;
