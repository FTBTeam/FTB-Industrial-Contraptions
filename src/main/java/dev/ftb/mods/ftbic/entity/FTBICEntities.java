...
public interface FTBICEntities {
	...
	static <T extends Entity> Supplier<EntityType<T>> register(String id, java.util.function.Function<ResourceKey<EntityType<?>>, EntityType.Builder<T>> builder) {
	...
	Supplier<EntityType<NukeArrowEntity>> NUKE_ARROW = register("nuke_arrow",
